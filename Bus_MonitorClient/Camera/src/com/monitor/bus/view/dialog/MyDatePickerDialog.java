...
public class MyDatePickerDialog extends Dialog {
    ...
    private void setParams(MyDatePickerDialog.Params params) {
        this.params = params;
    }
    ...
    public static class Builder {
        ...
        private final MyDatePickerDialog.Params params;
        ...
        public Builder(Context context) {
            ...
            params = new MyDatePickerDialog.Params();
        }
        ...
        public MyDatePickerDialog create() {
            final MyDatePickerDialog dialog = new MyDatePickerDialog(context, params.shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
