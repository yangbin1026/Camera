...
public class MyDataPickerDialog extends Dialog {
    ...
    public MyDataPickerDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    private void setParams(MyDataPickerDialog.Params params) {
        this.params = params;
    }
    ...
    public static class Builder {
        ...
        private final MyDataPickerDialog.Params params;

        public Builder(Context context) {
            this.context = context;
            params = new MyDataPickerDialog.Params();
        }
        ...
        public MyDataPickerDialog create() {
            final MyDataPickerDialog dialog = new MyDataPickerDialog(context, params.shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
