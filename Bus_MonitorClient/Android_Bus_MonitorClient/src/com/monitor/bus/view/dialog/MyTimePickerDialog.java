...
public class MyTimePickerDialog extends Dialog{
    ...
    public MyTimePickerDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    private void setParams(MyTimePickerDialog.Params params) {
        this.params = params;
    }
    ...
    public static class Builder {
        ...
        private final MyTimePickerDialog.Params params;

        public Builder(Context context) {
            this.context = context;
            params = new MyTimePickerDialog.Params();
        }
        ...
        public MyTimePickerDialog create() {
            final MyTimePickerDialog dialog = new MyTimePickerDialog(context, params.shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
